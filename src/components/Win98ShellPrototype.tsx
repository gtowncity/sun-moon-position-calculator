...
const eventRows = [
  ...
  ["04:05", "Sonne", "Buergerliche Daemmerung Beginn"]
];

const previewRows = [
  ["1", "Sonne", "16:00", "244.31", "46.13", "43.86", "--"],
  ["2", "Mond", "16:00", "120.54", "-20.31", "110.31", "61 %"],
  ["3", "Sonne", "17:00", "253.72", "38.44", "51.56", "--"],
  ["4", "Mond", "17:00", "134.20", "-15.80", "105.80", "62 %"],
  ["5", "Sonne", "18:00", "263.18", "29.22", "60.78", "--"],
  ["6", "Mond", "18:00", "147.94", "-10.12", "100.12", "62 %"],
  ["7", "Sonne", "19:00", "273.91", "18.62", "71.38", "--"],
  ["8", "Mond", "19:00", "161.30", "-3.64", "93.64", "63 %"],
  ["9", "Sonne", "20:00", "288.08", "7.51", "82.49", "--"],
  ["10", "Mond", "20:00", "174.70", "3.18", "86.82", "63 %"]
];
      ...
      <section className="win98-app-window" aria-label="Sun and Moon Position Calculator visual prototype">
        ...
        <main className="win98-content">
          <section className="win98-control-strip" aria-label="Eingaben">
            ...
            <fieldset className="win98-group win98-target-group"><legend>Ziel</legend><div className="win98-radio-list"><label><input type="radio" defaultChecked readOnly />Sonne + Mond</label><label><input type="radio" readOnly />Nur Sonne</label><label><input type="radio" readOnly />Nur Mond</label></div><select defaultValue="Eine Nacht"><option>Eine Nacht</option></select></fieldset>
            <fieldset className="win98-group win98-interval-group"><legend>Intervall</legend><div className="win98-field-grid"><label>Start<input value="07.07.2026 16:00" readOnly /></label><label>Schritt<select defaultValue="10 Minuten"><option>10 Minuten</option></select></label></div><p>Zeilen: 218</p></fieldset>
