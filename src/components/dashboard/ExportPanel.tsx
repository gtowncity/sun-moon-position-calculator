...
export function ExportPanel({ hasRows, onCsv, onXlsx, onTxt, onMarkdown, t }: ExportPanelProps) {
  return (
    <div className="export-panel" aria-label={t("exportSection")}>
      <span>[{t("exportResultData")}]</span>
      <RetroButton type="button" disabled={!hasRows} onClick={onCsv}>{t("exportCsv")}</RetroButton>
